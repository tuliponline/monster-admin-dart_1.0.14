...
import 'package:monster_fishing_admin/src/model/create_brand200_response.dart';
import 'package:monster_fishing_admin/src/model/delete_brand200_response.dart';
import 'package:monster_fishing_admin/src/model/get_brand_by_id200_response.dart';
import 'package:monster_fishing_admin/src/model/get_brands200_response.dart';
import 'package:monster_fishing_admin/src/model/result_response_error.dart';
import 'package:monster_fishing_admin/src/model/types_create_brand_request.dart';
import 'package:monster_fishing_admin/src/model/types_update_brand_request.dart';
import 'package:monster_fishing_admin/src/model/update_brand200_response.dart';
...
class BrandApi {
  ...
  Future<Response<CreateBrand200Response>> createBrand({ 
    TypesCreateBrandRequest? typesCreateBrandRequest,
    ...
    final _path = r'/admin/catalog/v1/brands';
    ...
    try {
      const _type = FullType(TypesCreateBrandRequest);
      _bodyData = typesCreateBrandRequest == null ? null : _serializers.serialize(typesCreateBrandRequest, specifiedType: _type);
  ...
  Future<Response<DeleteBrand200Response>> deleteBrand({ 
    ...
    final _path = r'/admin/catalog/v1/brands/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<GetBrands200Response>> getBrands({ 
    ...
    GetBrands200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetBrands200Response),
      ) as GetBrands200Response;
  ...
  Future<Response<UpdateBrand200Response>> updateBrand({ 
    required String id,
    required TypesUpdateBrandRequest typesUpdateBrandRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(TypesUpdateBrandRequest);
      _bodyData = _serializers.serialize(typesUpdateBrandRequest, specifiedType: _type);
