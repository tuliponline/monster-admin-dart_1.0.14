...
import 'package:monster_fishing_admin/src/model/create_category200_response.dart';
import 'package:monster_fishing_admin/src/model/delete_category200_response.dart';
import 'package:monster_fishing_admin/src/model/get_categories200_response.dart';
import 'package:monster_fishing_admin/src/model/get_category_by_id200_response.dart';
import 'package:monster_fishing_admin/src/model/result_response_error.dart';
import 'package:monster_fishing_admin/src/model/types_create_category_request.dart';
import 'package:monster_fishing_admin/src/model/types_update_category_request.dart';
import 'package:monster_fishing_admin/src/model/update_category200_response.dart';
...
class CategoryApi {
  ...
  Future<Response<CreateCategory200Response>> createCategory({ 
    TypesCreateCategoryRequest? typesCreateCategoryRequest,
    ...
    final _path = r'/admin/catalog/v1/categories';
    ...
    try {
      const _type = FullType(TypesCreateCategoryRequest);
      _bodyData = typesCreateCategoryRequest == null ? null : _serializers.serialize(typesCreateCategoryRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [DeleteCategory200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeleteCategory200Response>> deleteCategory({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/admin/catalog/v1/categories/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
    ...
    DeleteCategory200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DeleteCategory200Response),
      ) as DeleteCategory200Response;
    ...
    return Response<DeleteCategory200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<UpdateCategory200Response>> updateCategory({ 
    required String id,
    required TypesUpdateCategoryRequest typesUpdateCategoryRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(TypesUpdateCategoryRequest);
      _bodyData = _serializers.serialize(typesUpdateCategoryRequest, specifiedType: _type);
