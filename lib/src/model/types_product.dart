...
/// * [variations] 
@BuiltValue()
abstract class TypesProduct implements Built<TypesProduct, TypesProductBuilder> {
  ...
  factory TypesProduct([void updates(TypesProductBuilder b)]) = _$TypesProduct;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TypesProductBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TypesProduct> get serializer => _$TypesProductSerializer();
}

class _$TypesProductSerializer implements PrimitiveSerializer<TypesProduct> {
  @override
  final Iterable<Type> types = const [TypesProduct, _$TypesProduct];

  @override
  final String wireName = r'TypesProduct';
  ...
  void _deserializeProperties(
    ...
    required TypesProductBuilder result,
  ...
  @override
  TypesProduct deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = TypesProductBuilder();
